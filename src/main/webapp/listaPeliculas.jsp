            ...
            <%@page import="com.example.pruebalaboratorio1.beans.streaming" %>
                <%@page import="java.text.NumberFormat" %>
                    <%@page contentType="text/html" pageEncoding="UTF-8" %>
                        <% // CORRECCIÓN: Cambiar "lista" por "listaPeliculas" para que coincida con el bucle
                            ArrayList<pelicula> listaPeliculas = (ArrayList<pelicula>)
                                request.getAttribute("listaPeliculas");
                                //ArrayList<genero> listaGeneros = (ArrayList) request.getAttribute("listarGeneros");
                                    //ArrayList<streaming> listaStreaming = (ArrayList)
                                        request.getAttribute("listarStraming");
                                        ...
                                        <body>
                                            ...
                                            <table border="1">
                                                ...
                                                <% if (listaPeliculas !=null) { for (pelicula movie : listaPeliculas) {
                                                    %>
                                                    <tr>
                                                        <td><a
                                                                href="viewPelicula?idPelicula=<%= movie.getIdPelicula() %>">
                                                                <%=movie.getTitulo()%>
                                                            </a></td>
                                                        <td>
                                                            <%=movie.getDirector()%>
                                                        ...
                                                        <td>
                                                            <%=movie.getGenero().getNombre()%>
                                                        </td>
                                                        <td><a
                                                                href="listaActores?idPelicula=<%= movie.getIdPelicula() %>">Ver
                                                                Actores</a></td>
                                                    </tr>
                                                    <% } } else { %>
                                                        <tr>
